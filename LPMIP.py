...
for i in range(len(ALPHA)):
    ...
    LPcons.append(linear[6]-n*C*T*ALPHA[i])
    
    LPservers.append(sum(linear[4]))
    
    LPsleepToactive.append(linear[3])
    LPactiveTosleep.append(linear[2])
    LPValues.append(linear[7])
