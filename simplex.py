...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 11:11:33 2024
...
for i in range(len(ALPHA)):
    ...
    Simplexhistory.append(y)
    Simplexactiveservers.append(np.sum(y))
    
    Simplexobj.append(run[1])
    Simplexcons.append(run[2] - n*c*t*ALPHA[i])
